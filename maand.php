...
$calendarStart = (clone $monthStart)->modify('-'.($firstDayOfWeek-1).' days');
$calendarEnd = (clone $calendarStart)->modify('+41 days');

$result = getTasksForCalendar($pdo, $calendarStart->format('Y-m-d'), $calendarEnd->format('Y-m-d'), $currentUser['id']);
...
<head>
    ...
    <title>Maand - De Gouden Schoen</title>
...
<body class="<?= $isAdmin ? 'is-admin' : '' ?>">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="dag.php" class="nav-item active" data-page="calendar">
        ...
        <header class="calendar-header">
            <div class="calendar-navigation">
                ...
                <div class="current-period">
                    <span id="currentPeriodText">November</span>
                </div>
            ...
            <div class="month-year">
                <span id="monthYearText">2025</span>
            </div>
            
            <div class="view-toggle">
                <button class="btn-toggle" id="todayBtn">Huidige maand</button>
                <div class="toggle-group">
                    <a href="dag.php"><button class="toggle-btn" data-view="day">Dag</button></a>
                    <a href="week.php"><button class="toggle-btn" data-view="week">Week</button></a>
        ...
        <div class="calendar-container">
            ...
            <div class="calendar-view month-view active" id="monthView">
                <div class="month-header">
                    <div class="month-day-name">Ma</div>
                    <div class="month-day-name">Di</div>
                    <div class="month-day-name">Wo</div>
                    <div class="month-day-name">Do</div>
                    <div class="month-day-name">Vr</div>
                    <div class="month-day-name">Za</div>
                    <div class="month-day-name">Zo</div>
                </div>
                <div class="month-grid" id="monthGrid">
                    <!-- Grid wordt dynamisch gevuld door JavaScript -->
                </div>
            </div>
        </div>
    </main>
    ...
    <div class="modal" id="taskModal">
        <div class="modal-content task-detail-modal">
            ...
            <div class="admin-user-management" style="margin-top: 20px; padding: 20px; background: #f8f9fa; border-radius: 8px;">
                ...
                <!-- Gebruiker toevoegen -->
                <form method="POST" action="maand.php" style="margin-bottom: 15px;">
            ...
            <div class="task-actions">
                <?php if (!$isAdmin): ?>
                <form method="POST" action="maand.php" style="display: inline;">
